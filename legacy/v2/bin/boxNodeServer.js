...
child = exec("sudo python " + __dirname + "/beans/Microchip.py -n", function (error, serialnumber, stderr) {
    ...
    my_channel.bind('event_' + serialnumber, function (data) {
        ...
        if (gotSerialNumber) {
            /*
            if (data.message == "spotlight_activity_off") {
                console.log("LEDs OFF");
                child = exec("sudo python " + __dirname + "/beans/RadioEmitter.py 0 off", function (error, stdout, stderr) {
                    sys.print('stdout: ' + stdout);
                    sys.print('stderr: ' + stderr);
                    if (error !== null) {
                        console.log('exec error: ' + error);
            ...
            if (data.message == "spotlight_activity_on") {
                console.log("LEDs ON");
                child = exec("sudo python " + __dirname + "/beans/RadioEmitter.py 0 on", function (error, stdout, stderr) {
                    sys.print('stdout: ' + stdout);
                    sys.print('stderr: ' + stderr);
                    if (error !== null) {
                        console.log('exec error: ' + error);
            ...
            if (data.message == "fan_activity_off") {
                console.log("Fan OFF");
                child = exec("sudo python " + __dirname + "/beans/Relay_WiringPi.py 1 0", function (error, stdout, stderr) {
                    sys.print('stdout: ' + stdout);
                    sys.print('stderr: ' + stderr);
                    if (error !== null) {
                        console.log('exec error: ' + error);
            ...
            if (data.message == "fan_activity_on") {
                console.log("Fan ON");
                child = exec("sudo python " + __dirname + "/beans/Relay_WiringPi.py 1 1", function (error, stdout, stderr) {
                    sys.print('stdout: ' + stdout);
                    sys.print('stderr: ' + stderr);
                    if (error !== null) {
                        console.log('exec error: ' + error);
